    ...
    >
      <div className="w-full h-full md:px-20 px-4 sm:px-6">
        ...
        <div className="mt-16 sm:mt-24 md:mt-32 relative">
          <div className="relative z-50 xl:space-y-32 space-y-8 sm:space-y-12 md:space-y-16">
            {expCards.map((card, index) => (
              <div key={index} className="exp-card-wrapper">
                <div className="xl:w-2/6 mb-6 sm:mb-8 md:mb-0">
                  <GlowCard card={card}>
                    <div>
                      <img
                        src={card.imgPath}
                ...
                <div className="xl:w-4/6">
                  <div className="flex items-start">
                    ...
                    <div className="expText flex xl:gap-20 md:gap-10 gap-3 sm:gap-5 relative z-20">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <ul className="list-disc ms-4 sm:ms-5 mt-3 sm:mt-4 md:mt-5 flex flex-col gap-2 sm:gap-3 md:gap-5 text-white-50">
